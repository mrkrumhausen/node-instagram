(function() {
  ...
  Instagram.prototype.fetchLocations = function(latitude,longitude) {
    var self = this;
    var defer = q.defer();
    var url = 'https://api.instagram.com/v1/locations/search?lat='+latitude+'&lng='+longitude+'&access_token=369906.d065459.fefc6829a9134ab4a5b81073d5e4f40d'
    //var url = "https://api.instagram.com/v1/locations/search/?lat=55.6834&lng=12.57009&access_token=369906.d065459.fefc6829a9134ab4a5b81073d5e4f40d&DISTANCE=100"
    self._request(url, 'get').then(function(output) {
      defer.resolve(output);
    }).fail(function(err) {
      defer.reject(err);
  ...
  Instagram.prototype.fetchPlaceInfo = function(targetPlaceId) {
    var self = this;
    var defer = q.defer();
    var url = 'https://www.instagram.com/explore/locations/' + targetPlaceId + '/?__a=1';
